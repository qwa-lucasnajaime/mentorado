...
public interface EstruturaDadosMap {
	 ...
	 * telefone daquela pessoa
	 */
	public Map<Funcionario, List<ContatoFuncionario>> nomeTelefonesObjeto(final List<String> elemento);
	 ...
	 */
	public Integer chaveMaiorNumeroEntreValores(final Map<String, List<Integer>> map);
